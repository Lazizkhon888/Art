...
<html lang="">
   <head>
      ...
      <!--//meta tags ends here-->
      <!--booststrap-->
      <link href="css/bootstrap.min.css?123" rel="stylesheet" type="text/css" media="all">
      <!--//booststrap end-->
      <!-- font-awesome icons -->
      <link href="css/fontawesome-all.min.css?123" rel="stylesheet" type="text/css" media="all">
      <!-- //font-awesome icons -->
      <!--Shoping cart-->
      <link rel="stylesheet" href="css/shop.css?777" type="text/css" />
      <!--//Shoping cart-->
      <!--stylesheets-->
      <link href="css/style.css" rel='stylesheet?2333' type='text/css' media="all">
      <!--//stylesheets-->
